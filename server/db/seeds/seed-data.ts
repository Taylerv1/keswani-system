...
export const notifications = [
    { recipient_type: "client", recipient_id: CLIENT_IDS.c1, channel: "email" as const, subject: "Rent Payment Reminder", body: "Dear Ali, your rent of $500 is due on Jan 1st.", status: "sent" as const, sent_at: new Date("2025-01-01"), related_entity_type: "contract", related_entity_id: CONTRACT_IDS.ct1 },
    { recipient_type: "client", recipient_id: CLIENT_IDS.c2, channel: "whatsapp" as const, subject: "Rent Payment Reminder", body: "Dear Fatima, your rent of $700 is due on Feb 1st.", status: "sent" as const, sent_at: new Date("2025-02-01"), related_entity_type: "contract", related_entity_id: CONTRACT_IDS.ct2 },
    { recipient_type: "client", recipient_id: CLIENT_IDS.c6, channel: "email" as const, subject: "Rent Payment Confirmation", body: "Thank you for your payment of $900 for January.", status: "sent" as const, sent_at: new Date("2025-01-04"), related_entity_type: "contract", related_entity_id: CONTRACT_IDS.ct6 },
    { recipient_type: "client", recipient_id: CLIENT_IDS.c10, channel: "in_app" as const, subject: "Electricity Bill Ready", body: "Your electricity bill for Jan-Feb is ready. Amount: $12.00", status: "sent" as const, sent_at: new Date("2025-02-20") },
    { recipient_type: "client", recipient_id: CLIENT_IDS.c8, channel: "email" as const, subject: "Maintenance Update", body: "Your maintenance request has been received. We will assign a technician shortly.", status: "sent" as const, sent_at: new Date("2025-04-01") },
    { recipient_type: "employee", recipient_id: EMPLOYEE_IDS.emp1, channel: "in_app" as const, subject: "New Maintenance Request", body: "A new maintenance request has been assigned to you for Unit 101.", status: "sent" as const, sent_at: new Date("2025-02-10") },
    { recipient_type: "client", recipient_id: CLIENT_IDS.c3, channel: "whatsapp" as const, subject: "Rent Due Soon", body: "Dear Omar, this is a reminder that your rent is due in 3 days.", status: "pending" as const, scheduled_at: new Date("2025-06-28") },
    { recipient_type: "client", recipient_id: CLIENT_IDS.c7, channel: "email" as const, subject: "Electricity Bill Overdue", body: "Your electricity bill is overdue. Please make payment as soon as possible.", status: "failed" as const },
];
